...
main = do
    xmproc0 <- spawnPipe "/home/derek/.cabal/bin/xmobar -x 0 /home/derek/.config/xmobar/xmobarrc0"  -- Launches xmobar
    xmproc1 <- spawnPipe "/home/derek/.cabal/bin/xmobar -x 1 /home/derek/.config/xmobar/xmobarrc1"  -- Launches xmobar
    xmproc2 <- spawnPipe "/home/derek/.cabal/bin/xmobar -x 2 /home/derek/.config/xmobar/xmobarrc2"  -- Launches xmobar 
...
myManageHook = placeHook (withGaps (20,12,12,12) (smart (0.5,0.5))) <+> insertPosition End Newer <+> floatNextHook <+>
        ...
        where
            myTermApps    = ["urxvt", "xterm", "htop", "irssi"]
